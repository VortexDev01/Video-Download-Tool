...
class ButtonFrame(ctk.CTkFrame):
    """Premium action buttons for TikTok page."""
    ...
    def __init__(self, parent, controller):
        ...
        self.download_btn = ctk.CTkButton(
            ...
            corner_radius=10,
            height=45,
            command=controller.tiktok_start_download
        )
        ...
        self.cancel_btn = ctk.CTkButton(
            ...
            height=45,
            state="disabled",
            command=controller.tiktok_cancel_download
        )
        ...
        self.load_folder_btn = ctk.CTkButton(
            ...
            corner_radius=10,
            height=45,
            command=controller.tiktok_choose_folder
        )
        ...
        self.open_folder_btn = ctk.CTkButton(
            ...
            corner_radius=10,
            height=45,
            command=controller.tiktok_open_folder
        )
